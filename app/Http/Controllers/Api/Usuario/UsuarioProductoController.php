...
use App\Http\Requests\Api\StoreUsuarioProductoRequest;
use App\Http\Requests\Api\UpdateUsuarioProductoRequest;
...
{
    /**
     * Listado de los productos de segunda mano publicados por el usuario autenticado.
     */
    ...
    /**
     * Publica un producto de segunda mano. Stock fijado a 1 y type='segunda_mano'.
     */
    public function store(StoreUsuarioProductoRequest $request): JsonResponse
    {
    ...
    /**
     * Actualiza un producto de segunda mano del usuario autenticado.
     */
    public function update(UpdateUsuarioProductoRequest $request, int $id): JsonResponse
    {
        $producto = Product::find($id);

        if ($producto === null || $producto->type !== 'segunda_mano') {
            return response()->json([
                'success' => false,
        ...
        // Aseguramos invariantes de segunda mano: stock=1, type fijo.
        $datos['stock'] = 1;
        $datos['type']  = 'segunda_mano';
    ...
    /**
     * Elimina (soft delete) un producto de segunda mano del usuario.
     */
    ...
    /**
     * Sube imágenes para un producto de segunda mano del usuario.
     */
